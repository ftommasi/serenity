...
public:
    ...
    int get_next_graphene_cluser_boundary(TextPosition const& cursor) const;
    int get_prev_graphene_cluser_boundary(TextPosition const& cursor) const;

    int get_code_points_after_cursor(TextPosition const& cursor) const;
    int get_code_points_before_cursor(TextPosition const& cursor) const;
